...
78d43fb (Fix Mermaid diagram rendering for local kmeans)
...
As **P increases**, compute per worker decreases ~linearly (good scaling) _until communication dominates_.
